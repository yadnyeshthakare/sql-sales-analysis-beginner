...
This project analyzes retail transaction data using SQL for data exploration, business analysis, and reporting along basic data profiling in Python (YData Profiling) to assess data quality and structure.
...
Create the sales table using the provided schema

Import the CSV data

Run sales_analysis.sql to execute all analysis queries

### Python

Open Profiling.ipynb

Install dependencies (pandas, ydata-profiling)

Run all cells to generate the profiling report
